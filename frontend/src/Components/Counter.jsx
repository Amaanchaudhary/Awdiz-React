...
function Counter(){
    ...
    return(
        <div>
            ...
            <button id="button" onClick={() => rout('/')}>Go to homePage <i class="fa-solid fa-house"></i></button><br/>
            <h1>hello , {Name} </h1>
            <button onClick={() => setName((PrevName) => 'Buddy')} >Change Name</button><br/><br/>   
            <button onClick={() => setName('Amaan')} >Default Name</button>
